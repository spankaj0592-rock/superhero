...
async function findHero() {
    ...
    if(name.length != 0){
            ...
            superHeroList.innerHTML =
                `<div id="superhero-box">
                    <div id="superhero-image">
                        <a href="./superHeroProfile.html?${sh.id}" target="_blank">
                    ...
                    <div>
                        ...
                        likeButton +
                        `<span> <a href="./superHeroProfile.html?${sh.id}" target="_blank"><i class="fa-solid fa-circle-info"></i></a> </span>
                        </div>
        ...
        superHeroList.innerHTML = `<div id="loading"><img src="./js/loading.gif" alt="loading....."><br>Loading......</div>`;
        let tempList = "";
